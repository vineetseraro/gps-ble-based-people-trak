...
package io.akwa.traquer.emptrack.common.crop;
...
class HighlightView {
    ...
    private static final float HANDLE_RADIUS_DP = 13f;
    ...
    private boolean isClipPathSupported(Canvas canvas) {
        return Build.VERSION.SDK_INT != Build.VERSION_CODES.JELLY_BEAN_MR1 && ((Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) || Build.VERSION.SDK_INT > Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1 || !canvas.isHardwareAccelerated());
    }
