...
open class B68UIFloatLabelTextField: UITextField {
  ...
  */
  @IBInspectable open var activeTextColorfloatingLabel : UIColor = UIColor.gray{
    didSet {
  ...
  */
  fileprivate var cachedPlaceholder = String()
  ...
  override open var placeholder : String? {
    ...
    set (newValue) {
      ...
      if (cachedPlaceholder != newValue) {
        cachedPlaceholder = (newValue! as NSString) as String
