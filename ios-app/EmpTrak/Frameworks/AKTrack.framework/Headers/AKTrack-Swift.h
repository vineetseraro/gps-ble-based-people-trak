...
SWIFT_MODULE_NAMESPACE_PUSH("AKTrack")

SWIFT_CLASS("_TtC7AKTrack8GeoFence")
@interface GeoFence : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC7AKTrack15LocationTracker")
...
@interface LocationTracker (SWIFT_EXTENSION(AKTrack)) <CLLocationManagerDelegate>
