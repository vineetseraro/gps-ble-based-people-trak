...
const pointLocationTrackingService = function() {};
 ...
 * 
 */
pointLocationTrackingService.prototype.setClient = function(clientObj) {
 ...
 * 
 */
pointLocationTrackingService.prototype.setHeaders = function(headers) {
 ...
 * 
 */
pointLocationTrackingService.prototype.setConfigs = function() {
  // console.log('config');
 ...
 * 
 */
pointLocationTrackingService.prototype.get = function(searchParams, otherParams) {
 ...
 * 
 */
pointLocationTrackingService.prototype.count = function(searchParams = {}) {
 ...
 * 
 */
pointLocationTrackingService.prototype.formatResponse = data => data;
 ...
 * 
 */
pointLocationTrackingService.prototype.getColumnMap = function(key) {
  const map = {
    pkid: 'pkid',
 ...
 * 
 */
pointLocationTrackingService.prototype.getFilterParams = function(event) {
  const filters = {};
  ...
  if (event.queryStringParameters && event.queryStringParameters.filter) {
    ...
    filters.$or = [
      ...
      {
        'sensor.min': event.queryStringParameters.filter
      },
      {
 ...
 * 
 */
pointLocationTrackingService.prototype.getExtraParams = function(event) {
  const params = {};
  params.sort = {};
...
module.exports = new pointLocationTrackingService();
