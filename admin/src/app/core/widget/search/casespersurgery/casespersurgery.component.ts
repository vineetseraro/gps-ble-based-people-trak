...
@Component({
  selector: 'app-search-casespersurgery',
  templateUrl: './casespersurgery.component.html',
  styleUrls: ['./casespersurgery.component.css']
})
export class CasespersurgeryComponent implements OnInit {
