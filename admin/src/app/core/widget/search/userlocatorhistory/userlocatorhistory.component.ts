...
@Component({
  selector: 'app-search-userlocatorhistory',
  templateUrl: './userlocatorhistory.component.html',
...
export class UserLocatorHistoryComponent implements OnInit {
  ...
  searchRecord(searchValue:any) {
    ...
    if (this.showmessage === false )  {
      ...
      this.commonService.notifyOther({option: 'userlocatorhistory_search', value: this.searchObj});
      this.closeSearchBox('');
    }
  }
