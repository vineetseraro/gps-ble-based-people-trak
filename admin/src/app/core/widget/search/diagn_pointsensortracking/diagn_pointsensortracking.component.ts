...
@Component({
  selector: 'app-search-diagnpointsensortracking',
  templateUrl: './diagn_pointsensortracking.component.html'
  /*styleUrls: ['./diagn_producttracking.component.css'],*/
})
export class DiagnPointSensorTrackingComponent implements OnInit {
  ...
  searchRecord(searchValue:any) {
    ...
    this.commonService.notifyOther({ option: 'diagnpointsensortracking_search', value: query });
    this.closeit('');
    // let query = '';
    let searchObj: any;
    searchObj;
