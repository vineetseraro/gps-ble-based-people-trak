...
@Component({
  selector: 'app-search-app-gateway-search',
  templateUrl: './app-gateway-search.component.html',
  styleUrls: ['./app-gateway-search.component.css']
})
export class AppGatewaySearchComponent implements OnInit {
