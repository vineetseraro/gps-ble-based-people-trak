...
@Component({
  selector: 'app-search-tempTag',
  templateUrl: './tempTag.component.html',
  styleUrls: ['./tempTag.component.css']
})
export class TempTagSearchComponent implements OnInit {
  ...
  searchRecord(searchValue:any) {
    ...
    if (searchValue.name !== null && searchValue.name !== '') query += '&name=' + searchValue.name;
    if (searchValue.code !== null && searchValue.code !== '') query += '&code=' + searchValue.code;
    if (searchValue.minTemp !== null && searchValue.minTemp !== '')
      query += '&minTemp=' + searchValue.minTemp;
    if (searchValue.maxTemp !== null && searchValue.maxTemp !== '')
      query += '&maxTemp=' + searchValue.maxTemp;
    if (searchValue.measurementCycle !== null && searchValue.measurementCycle !== '')
      query += '&measurementCycle=' + searchValue.measurementCycle;
    if (searchValue.uid !== null && searchValue.uid !== '') query += '&uid=' + searchValue.uid;
    ...
    this.commonService.notifyOther({ option: 'tempTagSearch', value: query });
    this.closeit('');
  }
