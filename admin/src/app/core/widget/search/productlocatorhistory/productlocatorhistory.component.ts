...
@Component({
  selector: 'app-search-productlocatorhistory',
  templateUrl: './productlocatorhistory.component.html',
...
closeDialog() {
  ...
  searchRecord(searchValue:any) {
    ...
    if (this.showmessage === false )  {
      ...
      this.commonService.notifyOther({option: 'productlocatorhistory_search', value: this.searchObj});
      this.closeSearchBox('');
    }
