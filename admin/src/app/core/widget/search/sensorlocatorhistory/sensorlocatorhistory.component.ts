...
@Component({
  selector: 'app-search-sensorlocatorhistory',
  templateUrl: './sensorlocatorhistory.component.html',
...
closeDialog() {
  ...
  searchRecord(searchValue:any) {
    ...
    if (this.showmessage === false )  {
      ...
      this.commonService.notifyOther({option: 'sensorlocatorhistory_search', value: this.searchObj});
      this.closeSearchBox('');
    }
