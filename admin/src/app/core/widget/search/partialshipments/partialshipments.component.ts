...
@Component({
  selector: 'app-search-partialshipments',
  templateUrl: './partialshipments.component.html',
  styleUrls: ['./partialshipments.component.css']
})
export class PartialshipmentsComponent implements OnInit {
  ...
  searchRecord(searchValue:any) {
    ...
    this.commonService.notifyOther({ option: 'partialshipments_search', value: query });
    this.closeit('');
  }
