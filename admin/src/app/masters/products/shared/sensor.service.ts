...
import { Sensor, SensorModel } from './sensor.model';
import { Injectable } from '@angular/core';
import {Observable} from 'rxjs/Rx';

@Injectable()
export class SensorService {
  serviceUrl = 'sensors' + environment.serverEnv;
   ...
   */
  getAll(query: string): Observable<SensorModel> {
  ...
  /**
   * Read the sensor api ( Public mode )
   * @param id
   */
  getPublic(id) {
