...
describe('Attribute Routing', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [NotificationBoxComponent, PageComponent,
                AttributeListComponent, AttributeComponent,
    ...
    it('should go on attribute list screen when we use /attribute ', async(() => {
        router.navigate(['/attributes']).then(() => {
            expect(location.path()).toBe('/attributes');
