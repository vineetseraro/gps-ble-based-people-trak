...
@Component({
  selector: 'app-report-casespersurgery',
  templateUrl: './report-casespersurgery.component.html',
  styleUrls: ['./report-casespersurgery.component.css'],
  providers: [OrderService, GlobalService]
})
export class ReportCasespersurgeryComponent implements OnInit {
 ...
 onResize(event:any) {
  ...
  public getOrderList(query: string) {
    this.loader = true;
    this.orderService.getReports('orders-by-surgery', query).subscribe((data:any) => {
