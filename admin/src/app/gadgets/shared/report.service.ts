...
export class ReportService {
   ...
   */
  getGraphData(type): Observable<ReportModel> {
   ...
   * Get All Record Lists
   */
  getGadgetData(type, query: string): Observable<ReportModel> {
    return this.akRestService.get(this.serviceUrl + '/get-graph-report?type='+type + query)
      .map((res:any) => res.json());
  }
